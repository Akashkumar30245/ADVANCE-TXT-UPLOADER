...
# Logging channel
LOG_CHANNEL =  -1002524058716 # Replace with your actual log channel ID
...
OWNER_ID =  7925792971 # Replace with the actual owner's user ID

# List of sudo users (initially empty or pre-populated)
SUDO_USERS = [7925792971, 8199692061]

AUTH_CHANNEL = -1002551977817
